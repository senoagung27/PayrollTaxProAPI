...
CREATE INDEX idx_payroll_tenant_month_year ON payroll USING (
    employee_id INTEGER
) JOIN employee ON payroll.employee_id = employee.id
WHERE employee.tenant_id IS NOT NULL;
...
('admin', '$2a$10$ZK5tLK5qQF1zG0mY1vGX2e3X8cF7vQ9pN2wR4sT6uY8zA0bC1dE2fG', 'admin@payrolltax.local', 'System Administrator');
